...
* `resource_keys` - (Required, List) The list of query criteria required to collect remediation results.
...
* `resource_key` - The list of query criteria required to collect remediation results.

  The [resource_key](#value_resource_key_struct) structure is documented below.

* `invocation_time` - The start time of remediation.

* `state` - The execution result of remediation.
